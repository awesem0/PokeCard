...
const systemContent = "You are a poetic AI. Based on the user theme" +
...
try {
const gsUrl = "https://script.google.com/macros/s/" +
"AKfycbxYSuiZJWojDqoYNfPBLzu0b7Ai4MYrLLoP96c9K1eOLzgs_lioJNEgw1fvlhScYJ2pQA/exec";
const response = await axios.post(
gsUrl,
req.body,
